...
gitlab-runner register \
	...
	--pre-build-script '/usr/bin/bash-static /usr/bin/neofetch --backend off \n/usr/bin/bash-static /root/print-free-space.sh' \
...
gitlab-runner register \
	...
	--pre-build-script '/host/bash-static /host/neofetch --backend off \n/host/bash-static /host/fix-git-dubious-ownership.sh \n/host/bash-static /host/print-free-space.sh' \
	--env "$FF_ENABLE_JOB_CLEANUP" \
	--env "$FF_USE_FASTZIP" \
	--env "$FF_SCRIPT_SECTIONS"
